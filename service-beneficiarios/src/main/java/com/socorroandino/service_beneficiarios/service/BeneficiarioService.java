...
public class BeneficiarioService {
    ...
    public Inventario guardarOActualizarInventario(Inventario item) {
    ...
    public EntregaDonacion registrarEntrega(Long idBeneficiario, Long idInventario, Integer cantidad, Long idUsuarioResponsable) {
        // 1. Validar comunicación con microservicio externo usuarios
        validarUsuarioResponsable(idUsuarioResponsable);

        // 2. Validar que existan los recursos locales
    ...
    public List<EntregaDonacion> listarHistorialEntregas() {
